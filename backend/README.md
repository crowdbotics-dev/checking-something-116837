...
## Project Structure
    ...
    ├── checking_something_116837  # Django project configurations
...
1. Clone this repo and `cd checking_something_116837`
...
2. Clone this repo and `cd checking_something_116837`
